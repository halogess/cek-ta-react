...
const MahasiswaHistoryItem = ({ id, filename, date, size, status, errorCount, onCancel, onDetail, judulBuku, type, bab, showCancelButton = true }) => {
    ...
    >
      <Stack direction="row" spacing={1} alignItems="center" sx={{ flex: 1, minWidth: 0 }}>
        ...
        <Box sx={{ flex: 1, minWidth: 0 }}>
          <Typography fontWeight="600">{type === 'book' ? filename : filename}</Typography>
        </Box>
      </Stack>
      {type === 'book' && bab && bab.length > 0 ? (
        <Box sx={{ flex: '0 0 40%', mx: 2, minWidth: 0 }}>
...
export default MahasiswaHistoryItem;
